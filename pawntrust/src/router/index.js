...
const routes = [
	...
	},
	{
		path: '/pawnit/quote',
		name: 'PawnItQuote',
		component: () => import(/* webpackChunkName: "LoginLayout" */ '../views/GetAQuote.vue'),
		params : true,
		props : true
	},
	{
	...
	},
	{
		path: '/sellproduct',
		name: 'SellProduct',
		component: () => import(/* webpackChunkName: "LoginLayout" */ '../views/SellItDetails.vue'),
		params : true,
		props : true
	},
	{
	...
	},
	{
		...
		name: 'ProductDetails',
		component: () => import(/* webpackChunkName: "LoginLayout" */ '../views/ProductDetails.vue'),
		params : true,
		props : true
	},
	{
