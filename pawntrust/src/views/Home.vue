            ...
            >
                ...
                >
                    ...
                    <div class="bannerBackground" style="display:flex; flex-direction:column;justify-content:flex-start; align-items:center;padding-top: 36px;">
                        ...
                        color="#F19B14"
                        height="6%"
                        style="margin-right: 62%;margin-top: 2%;"
                        >
...
import Footer from '../components/Footer.vue';
    export default {
        ...
        data: () => ({
            slides : 3,
            pawnshopsparagraph : "We will bring the pawn shop online, providing worldwide access through our platform. This gives the customer the ability to do business online, rather than the traditional method of walking into a brick-and-mortar shop, where there is substandard service and embarrassment from face-to-face contact. This platform will further collaborate worldwide inventory giving the individual Pawn Shop exponential exposure.",
